...
const ko: LocalizedContent = {
  ui: {
    ...
    closeDayAction: '오늘 마감', resultCompleteTitle: '완료.', resultIncompleteTitle: '미완성.', resultCompleteCopy: '오늘의 기준을 지켰다.',
    incompleteCloseTitle: '아직 {count}개 남았다.', incompleteCloseCopy: '이대로 마감하면 오늘은 미완성으로 기록된다.', returnToRoutines: '돌아가기', closeIncomplete: '미완성으로 마감',
...
const en: LocalizedContent = {
  ui: {
    ...
    closeDayAction: 'Close today', resultCompleteTitle: 'Complete.', resultIncompleteTitle: 'Incomplete.', resultCompleteCopy: "You held today's standard.",
    incompleteCloseTitle: 'You still have {count} left.', incompleteCloseCopy: 'Closing now will record today as incomplete.', returnToRoutines: 'Go back', closeIncomplete: 'Close as incomplete',
...
const ja = clone(en, {
  ui: {
    ...
    closeDayAction: '今日を締める', resultCompleteTitle: '完了。', resultIncompleteTitle: '未完了。', resultCompleteCopy: '今日の基準を守った。', incompleteCloseTitle: 'まだ{count}件残っている。', incompleteCloseCopy: 'このまま締めると、今日は未完了として記録される。', returnToRoutines: '戻る', closeIncomplete: '未完了で締める', completedRoutines: '完了ルーティン', incompleteRoutines: '未完了ルーティン', completionStreakLabel: '連続完了', reflection: '一日の振り返り', todayRecord: '今日の記録', personalRoutineAdd: '個人ルーティンを追加', routineName: 'ルーティン名', routinePlaceholder: '例：懸垂10回', category: 'カテゴリー', scope: '適用期間',
...
const todayExperienceUi: Record<AppLocale, Record<string, string>> = {
  ko: {
    closeDayAction: '오늘 마감',
    closeIncomplete: '미완성으로 마감',
    edit: '편집',
    finishEditing: '완료',
    restoreDefaultRoutines: '기본 루틴 복원',
    routinesRestoredToast: '기본 루틴을 복원했습니다.',
    routineRemovedToast: '루틴을 삭제했습니다.',
    undo: '되돌리기',
    lastCourseRoutineToast: '과정 루틴은 하나 이상 남겨야 합니다.',
    routineNameRequired: '루틴명을 입력해라.',
    reorderRoutine: '{name} 순서 변경',
    moveRoutineUp: '{name} 위로 이동',
    moveRoutineDown: '{name} 아래로 이동',
    editTodayCard: '오늘 카드 편집',
    ninetyDayProgress: '90일 과정 진행',
    todayStandard: '오늘의 기준',
    defaultStandardLabel: '기본 문구',
    standardPrompt: '직접 바꿀 문장',
    standardPlaceholder: '예) 시작한 일은 오늘 끝낸다.',
    standardDefaultHelper: '비워두면 위 기본 문구를 사용합니다.',
    standardSavedToast: '오늘의 기준을 저장했습니다.',
    standardClearedToast: '기본 문구를 사용합니다.',
    standardLockedToast: '마감 후에는 오늘의 기준을 수정할 수 없습니다.',
    noStandard: '정한 기준 없음',
    incompleteCloseCopy: '이대로 마감하면 오늘은 미완성으로 기록된다.',
    incompleteCloseTitle: '아직 {count}개 남았다.',
    resultCompleteCopy: '오늘의 기준을 지켰다.',
    returnToRoutines: '돌아가기',
  },
  en: {
    closeDayAction: 'Close today',
    closeIncomplete: 'Close as incomplete',
    edit: 'Edit',
    finishEditing: 'Done',
    restoreDefaultRoutines: 'Restore default routines',
    routinesRestoredToast: 'Default routines restored.',
    routineRemovedToast: 'Routine deleted.',
    undo: 'Undo',
    lastCourseRoutineToast: 'Keep at least one course routine.',
    routineNameRequired: 'Enter a routine name.',
    reorderRoutine: 'Reorder {name}',
    moveRoutineUp: 'Move {name} up',
    moveRoutineDown: 'Move {name} down',
    editTodayCard: "Edit today's card",
    ninetyDayProgress: '90-day program progress',
    todayStandard: "Today's standard",
    defaultStandardLabel: 'Default phrase',
    standardPrompt: 'Write your own phrase',
    standardPlaceholder: 'e.g. Finish what I start today.',
    standardDefaultHelper: 'Leave blank to use the default phrase above.',
    standardSavedToast: "Today's standard saved.",
    standardClearedToast: 'Using the default phrase.',
    standardLockedToast: "Today's standard cannot be changed after closing the day.",
    noStandard: 'No standard set',
    incompleteCloseCopy: 'Closing now will record today as incomplete.',
    incompleteCloseTitle: 'You still have {count} left.',
    resultCompleteCopy: "You held today's standard.",
    returnToRoutines: 'Go back',
  },
  ja: {
    closeDayAction: '今日を締める',
    closeIncomplete: '未完了で締める',
    edit: '編集',
    finishEditing: '完了',
    restoreDefaultRoutines: '標準ルーティンを復元',
    routinesRestoredToast: '標準ルーティンを復元しました。',
    routineRemovedToast: 'ルーティンを削除しました。',
    undo: '元に戻す',
    lastCourseRoutineToast: 'コースルーティンを1つ以上残してください。',
    routineNameRequired: 'ルーティン名を入力してください。',
    reorderRoutine: '{name}の順序を変更',
    moveRoutineUp: '{name}を上へ移動',
    moveRoutineDown: '{name}を下へ移動',
    editTodayCard: '今日のカードを編集',
    ninetyDayProgress: '90日プログラムの進捗',
    todayStandard: '今日の基準',
    defaultStandardLabel: 'デフォルトの文',
    standardPrompt: '自分の文に変更',
    standardPlaceholder: '例）始めたことは今日終える。',
    standardDefaultHelper: '空欄にすると上のデフォルト文を使います。',
    standardSavedToast: '今日の基準を保存しました。',
    standardClearedToast: 'デフォルトの文を使用します。',
    standardLockedToast: '一日を締めた後は今日の基準を変更できません。',
    noStandard: '基準なし',
    incompleteCloseCopy: 'このまま締めると、今日は未完了として記録される。',
    incompleteCloseTitle: 'まだ{count}件残っている。',
    resultCompleteCopy: '今日の基準を守った。',
    returnToRoutines: '戻る',
  },
  es: {
    closeDayAction: 'Cerrar el día',
    closeIncomplete: 'Cerrar como incompleto',
    edit: 'Editar',
    finishEditing: 'Listo',
    restoreDefaultRoutines: 'Restaurar rutinas predeterminadas',
    routinesRestoredToast: 'Rutinas predeterminadas restauradas.',
    routineRemovedToast: 'Rutina eliminada.',
    undo: 'Deshacer',
    lastCourseRoutineToast: 'Mantén al menos una rutina del curso.',
    routineNameRequired: 'Escribe un nombre para la rutina.',
    reorderRoutine: 'Cambiar el orden de {name}',
    moveRoutineUp: 'Subir {name}',
    moveRoutineDown: 'Bajar {name}',
    editTodayCard: 'Editar la tarjeta de hoy',
    ninetyDayProgress: 'Progreso del programa de 90 días',
    todayStandard: 'Estándar de hoy',
    defaultStandardLabel: 'Frase predeterminada',
    standardPrompt: 'Escribe tu propia frase',
    standardPlaceholder: 'Ej. Hoy termino lo que empiezo.',
    standardDefaultHelper: 'Déjalo en blanco para usar la frase predeterminada de arriba.',
    standardSavedToast: 'Estándar de hoy guardado.',
    standardClearedToast: 'Se usará la frase predeterminada.',
    standardLockedToast: 'El estándar de hoy no se puede cambiar después de cerrar el día.',
    noStandard: 'Sin estándar',
    incompleteCloseCopy: 'Si cierras ahora, hoy quedará registrado como incompleto.',
    incompleteCloseTitle: 'Aún quedan {count}.',
    resultCompleteCopy: 'Cumpliste el estándar de hoy.',
    returnToRoutines: 'Volver',
  },
  de: {
    closeDayAction: 'Tag abschließen',
    closeIncomplete: 'Unvollständig abschließen',
    edit: 'Bearbeiten',
    finishEditing: 'Fertig',
    restoreDefaultRoutines: 'Standardroutinen wiederherstellen',
    routinesRestoredToast: 'Standardroutinen wiederhergestellt.',
    routineRemovedToast: 'Routine gelöscht.',
    undo: 'Rückgängig',
    lastCourseRoutineToast: 'Mindestens eine Kursroutine muss bleiben.',
    routineNameRequired: 'Gib einen Routinenamen ein.',
    reorderRoutine: 'Reihenfolge von {name} ändern',
    moveRoutineUp: '{name} nach oben',
    moveRoutineDown: '{name} nach unten',
    editTodayCard: 'Heutige Karte bearbeiten',
    ninetyDayProgress: 'Fortschritt im 90-Tage-Programm',
    todayStandard: 'Heutiger Standard',
    defaultStandardLabel: 'Standardsatz',
    standardPrompt: 'Eigener Satz',
    standardPlaceholder: 'z. B. Heute beende ich, was ich beginne.',
    standardDefaultHelper: 'Leer lassen, um den Standardsatz oben zu verwenden.',
    standardSavedToast: 'Heutiger Standard gespeichert.',
    standardClearedToast: 'Der Standardsatz wird verwendet.',
    standardLockedToast: 'Nach Tagesabschluss kann der heutige Standard nicht geändert werden.',
    noStandard: 'Kein Standard festgelegt',
    incompleteCloseCopy: 'Wenn du jetzt abschließt, wird der heutige Tag als unvollständig gespeichert.',
    incompleteCloseTitle: 'Noch {count} offen.',
    resultCompleteCopy: 'Du hast deinen heutigen Standard gehalten.',
    returnToRoutines: 'Zurück',
  },
  fr: {
    closeDayAction: 'Clore la journée',
    closeIncomplete: 'Clore comme incomplète',
    edit: 'Modifier',
    finishEditing: 'Terminé',
    restoreDefaultRoutines: 'Rétablir les routines par défaut',
    routinesRestoredToast: 'Routines par défaut rétablies.',
    routineRemovedToast: 'Routine supprimée.',
    undo: 'Annuler',
    lastCourseRoutineToast: 'Garde au moins une routine du parcours.',
    routineNameRequired: 'Saisis un nom de routine.',
    reorderRoutine: 'Réorganiser {name}',
    moveRoutineUp: 'Monter {name}',
    moveRoutineDown: 'Descendre {name}',
    editTodayCard: 'Modifier la carte du jour',
    ninetyDayProgress: 'Progression du programme de 90 jours',
    todayStandard: "Règle d'aujourd'hui",
    defaultStandardLabel: 'Phrase par défaut',
    standardPrompt: 'Écris ta propre phrase',
    standardPlaceholder: "Ex. Aujourd'hui, je termine ce que je commence.",
    standardDefaultHelper: 'Laisse vide pour utiliser la phrase par défaut ci-dessus.',
    standardSavedToast: "Règle d'aujourd'hui enregistrée.",
    standardClearedToast: 'La phrase par défaut sera utilisée.',
    standardLockedToast: "La règle d'aujourd'hui ne peut plus être modifiée après la clôture.",
    noStandard: 'Aucune règle définie',
    incompleteCloseCopy: 'Si tu clos maintenant, cette journée sera enregistrée comme incomplète.',
    incompleteCloseTitle: 'Il en reste encore {count}.',
    resultCompleteCopy: 'Tu as respecté l’exigence du jour.',
    returnToRoutines: 'Retour',
  },
  zh: {
    closeDayAction: '结束今天',
    closeIncomplete: '按未完成结束',
    edit: '编辑',
    finishEditing: '完成',
    restoreDefaultRoutines: '恢复默认习惯',
    routinesRestoredToast: '已恢复默认习惯。',
    routineRemovedToast: '已删除习惯。',
    undo: '撤销',
    lastCourseRoutineToast: '课程习惯至少保留一项。',
    routineNameRequired: '请输入习惯名称。',
    reorderRoutine: '调整{name}的顺序',
    moveRoutineUp: '上移{name}',
    moveRoutineDown: '下移{name}',
    editTodayCard: '编辑今日卡片',
    ninetyDayProgress: '90天计划进度',
    todayStandard: '今日标准',
    defaultStandardLabel: '默认语句',
    standardPrompt: '自定义一句话',
    standardPlaceholder: '例如：今天完成已经开始的事。',
    standardDefaultHelper: '留空将使用上方默认语句。',
    standardSavedToast: '今日标准已保存。',
    standardClearedToast: '将使用默认语句。',
    standardLockedToast: '结束当天后无法修改今日标准。',
    noStandard: '尚未设定标准',
    incompleteCloseCopy: '现在结束，今天将被记录为未完成。',
    incompleteCloseTitle: '还有 {count} 项未完成。',
    resultCompleteCopy: '你守住了今天的标准。',
    returnToRoutines: '返回',
  },
  'pt-BR': {
    closeDayAction: 'Encerrar o dia',
    closeIncomplete: 'Encerrar como incompleto',
    edit: 'Editar',
    finishEditing: 'Concluir',
    restoreDefaultRoutines: 'Restaurar rotinas padrão',
    routinesRestoredToast: 'Rotinas padrão restauradas.',
    routineRemovedToast: 'Rotina excluída.',
    undo: 'Desfazer',
    lastCourseRoutineToast: 'Mantenha pelo menos uma rotina do curso.',
    routineNameRequired: 'Digite um nome para a rotina.',
    reorderRoutine: 'Reordenar {name}',
    moveRoutineUp: 'Mover {name} para cima',
    moveRoutineDown: 'Mover {name} para baixo',
    editTodayCard: 'Editar cartão de hoje',
    ninetyDayProgress: 'Progresso do programa de 90 dias',
    todayStandard: 'Padrão de hoje',
    defaultStandardLabel: 'Frase padrão',
    standardPrompt: 'Escreva sua própria frase',
    standardPlaceholder: 'Ex.: Hoje termino o que começo.',
    standardDefaultHelper: 'Deixe em branco para usar a frase padrão acima.',
    standardSavedToast: 'Padrão de hoje salvo.',
    standardClearedToast: 'A frase padrão será usada.',
    standardLockedToast: 'O padrão de hoje não pode ser alterado após encerrar o dia.',
    noStandard: 'Nenhum padrão definido',
    incompleteCloseCopy: 'Se encerrar agora, o dia será registrado como incompleto.',
    incompleteCloseTitle: 'Ainda faltam {count}.',
    resultCompleteCopy: 'Você manteve o padrão de hoje.',
    returnToRoutines: 'Voltar',
  },
  'zh-Hant': {
    closeDayAction: '結束今天',
    closeIncomplete: '以未完成結束',
    edit: '編輯',
    finishEditing: '完成',
    restoreDefaultRoutines: '恢復預設習慣',
    routinesRestoredToast: '已恢復預設習慣。',
    routineRemovedToast: '已刪除習慣。',
    undo: '復原',
    lastCourseRoutineToast: '課程習慣至少保留一項。',
    routineNameRequired: '請輸入習慣名稱。',
    reorderRoutine: '調整{name}的順序',
    moveRoutineUp: '上移{name}',
    moveRoutineDown: '下移{name}',
    editTodayCard: '編輯今日卡片',
    ninetyDayProgress: '90天計畫進度',
    todayStandard: '今日標準',
    defaultStandardLabel: '預設語句',
    standardPrompt: '自訂一句話',
    standardPlaceholder: '例如：今天完成已經開始的事。',
    standardDefaultHelper: '留空將使用上方預設語句。',
    standardSavedToast: '今日標準已儲存。',
    standardClearedToast: '將使用預設語句。',
    standardLockedToast: '結束當天後無法修改今日標準。',
    noStandard: '尚未設定標準',
    incompleteCloseCopy: '現在結束，今天將記錄為未完成。',
    incompleteCloseTitle: '還有 {count} 項未完成。',
    resultCompleteCopy: '你守住了今天的標準。',
    returnToRoutines: '返回',
  },
  it: {
    closeDayAction: 'Chiudi la giornata',
    closeIncomplete: 'Chiudi come incompleto',
    edit: 'Modifica',
    finishEditing: 'Fine',
    restoreDefaultRoutines: 'Ripristina routine predefinite',
    routinesRestoredToast: 'Routine predefinite ripristinate.',
    routineRemovedToast: 'Routine eliminata.',
    undo: 'Annulla',
    lastCourseRoutineToast: 'Mantieni almeno una routine del percorso.',
    routineNameRequired: 'Inserisci un nome per la routine.',
    reorderRoutine: 'Riordina {name}',
    moveRoutineUp: 'Sposta {name} in alto',
    moveRoutineDown: 'Sposta {name} in basso',
    editTodayCard: 'Modifica la scheda di oggi',
    ninetyDayProgress: 'Avanzamento del programma di 90 giorni',
    todayStandard: 'Standard di oggi',
    defaultStandardLabel: 'Frase predefinita',
    standardPrompt: 'Scrivi la tua frase',
    standardPlaceholder: 'Es. Oggi finisco ciò che inizio.',
    standardDefaultHelper: 'Lascia vuoto per usare la frase predefinita qui sopra.',
    standardSavedToast: 'Standard di oggi salvato.',
    standardClearedToast: 'Verrà usata la frase predefinita.',
    standardLockedToast: 'Lo standard di oggi non può essere modificato dopo la chiusura.',
    noStandard: 'Nessuno standard impostato',
    incompleteCloseCopy: 'Se chiudi ora, oggi verrà registrato come incompleto.',
    incompleteCloseTitle: 'Ne restano ancora {count}.',
    resultCompleteCopy: 'Hai rispettato lo standard di oggi.',
    returnToRoutines: 'Indietro',
  },
};

const courseCompletionUi: Record<AppLocale, Record<string, string>> = {
  ko: {
    shareApp: '친구에게 앱 공유하기',
    shareAppTitle: 'ALPHA 공유하기',
    shareAppMessage: '90일 동안 내 기준을 끝까지 지켰다.\n이제 네 차례다.\n\nALPHA로 시작해라.',
    shareFailedToast: '공유창을 열지 못했습니다.',
  },
  en: {
    shareApp: 'Share ALPHA with a friend',
    shareAppTitle: 'Share ALPHA',
    shareAppMessage: 'I held my standard for 90 days.\nNow it is your turn.\n\nStart with ALPHA.',
    shareFailedToast: 'Could not open the share sheet.',
  },
  ja: {
    shareApp: '友達にアプリを共有',
    shareAppTitle: 'ALPHAを共有',
    shareAppMessage: '90日間、自分の基準を守り抜いた。\n次はあなたの番だ。\n\nALPHAで始めよう。',
    shareFailedToast: '共有画面を開けませんでした。',
  },
  es: {
    shareApp: 'Compartir la app con un amigo',
    shareAppTitle: 'Compartir ALPHA',
    shareAppMessage: 'Mantuve mi estándar durante 90 días.\nAhora te toca a ti.\n\nEmpieza con ALPHA.',
    shareFailedToast: 'No se pudo abrir el menú para compartir.',
  },
  de: {
    shareApp: 'App mit einem Freund teilen',
    shareAppTitle: 'ALPHA teilen',
    shareAppMessage: 'Ich habe meinen Maßstab 90 Tage lang gehalten.\nJetzt bist du dran.\n\nStarte mit ALPHA.',
    shareFailedToast: 'Das Teilen-Menü konnte nicht geöffnet werden.',
  },
  fr: {
    shareApp: 'Partager l’app avec un ami',
    shareAppTitle: 'Partager ALPHA',
    shareAppMessage: 'J’ai tenu mon exigence pendant 90 jours.\nÀ ton tour.\n\nCommence avec ALPHA.',
    shareFailedToast: 'Impossible d’ouvrir le menu de partage.',
  },
  zh: {
    shareApp: '把应用分享给朋友',
    shareAppTitle: '分享 ALPHA',
    shareAppMessage: '我坚持自己的标准走完了90天。\n现在轮到你了。\n\n从 ALPHA 开始。',
    shareFailedToast: '无法打开分享面板。',
  },
  'pt-BR': {
    shareApp: 'Compartilhar o app com um amigo',
    shareAppTitle: 'Compartilhar o ALPHA',
    shareAppMessage: 'Mantive meu padrão por 90 dias.\nAgora é a sua vez.\n\nComece com o ALPHA.',
    shareFailedToast: 'Não foi possível abrir o menu de compartilhamento.',
  },
  'zh-Hant': {
    shareApp: '把 App 分享給朋友',
    shareAppTitle: '分享 ALPHA',
    shareAppMessage: '我堅持自己的標準走完了90天。\n現在輪到你了。\n\n從 ALPHA 開始。',
    shareFailedToast: '無法開啟分享選單。',
  },
  it: {
    shareApp: 'Condividi l’app con un amico',
    shareAppTitle: 'Condividi ALPHA',
    shareAppMessage: 'Ho mantenuto il mio standard per 90 giorni.\nOra tocca a te.\n\nInizia con ALPHA.',
    shareFailedToast: 'Impossibile aprire il menu di condivisione.',
  },
};
...
function withCropEditorUi(locale: AppLocale, content: LocalizedContent): LocalizedContent {
  return {
    ...
    ui: {
      ...content.ui,
      ...cropEditorUi[locale],
      ...todayExperienceUi[locale],
      ...courseCompletionUi[locale],
    },
  };
}
