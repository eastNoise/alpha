export const visuals = {
  ...
  courseStage: require('../assets/visuals/course_stage.jpg'),
  finishSuccess: require('../assets/visuals/finish_success.jpg'),
  finishFail: require('../assets/visuals/finish_fail.jpg'),
  avatar: require('../assets/visuals/avatar_alpha.jpg'),
};
