...
최종 확인: 2026-09-08 KST

현재 한국 공개 페이지는 HTTP 200, 버전 `1.0.6`이다. 아래 검토 중 설명은 9월 3일 제출 당시 이력이다. 모든 국가의 전파·사전 출시 보고서·실기기 QA를 확인한 것은 아니다. 후속 정리는 `../post-release-status-2026-09-08.md`를 참조한다.
